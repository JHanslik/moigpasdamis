...
const Profile = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className=" mt-10 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 pt-10">
        <div className="flex flex-col items-center pb-10">
          <h5 className="mt-4  mb-2 text-xl font-medium text-gray-900 dark:text-white">
            Email
          </h5>
          {!customerInfo?.email ? (
            "Non renseigné"
